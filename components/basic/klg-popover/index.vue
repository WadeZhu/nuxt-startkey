...
export default {
  ...
  computed: {
    arrowClass () {
      return {
        'klg-popover-arrow': true,
        'klg-popover-arrow-up': this.placement === 'bottom',
        'klg-popover-arrow-right': this.placement === 'left',
        'klg-popover-arrow-left': this.placement === 'right',
        'klg-popover-arrow-down': this.placement === 'top'
      }
    }
  }
}
