...
export default class Siema {
  ...
  constructor(options) {
    ...
    const methods = ['resizeHandler', 'touchstartHandler', 'touchendHandler', 'touchmoveHandler', 'mousedownHandler', 'mouseupHandler', 'mouseleaveHandler', 'mousemoveHandler']
  ...
  touchmoveHandler(e) {
    e.stopPropagation()
    e.preventDefault()  // fix android touchend event not fired https://code.google.com/p/android/issues/detail?id=19827
    if (this.pointerDown) {
